  ...
  return <Link to="/services" className="animate-fade-in transition-all duration-500 ease-in-out" style={{
    animationDelay: `${150 + index * 75}ms`
      ...
      <div className="flex flex-col items-center text-center">
        <div className={`p-2 mb-1.5 w-14 h-14 flex items-center justify-center overflow-hidden transition-all duration-500 ease-in-out ${isSticky ? 'bg-blue-200/50' : 'bg-blue-100'} px-[6px] py-[6px] rounded-full`}>
