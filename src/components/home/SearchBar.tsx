...
const SearchBar: React.FC = () => {
  ...
  return (
    <div className="mb-4 mt-2 animate-fade-in animate-stagger-1 relative z-[9999]" ref={searchRef}>
      ...
      {showSuggestions && suggestions.length > 0 && (
        <div className="absolute z-[9999] mt-1 w-full max-w-md bg-white rounded-md shadow-lg border border-gray-100 overflow-hidden">
