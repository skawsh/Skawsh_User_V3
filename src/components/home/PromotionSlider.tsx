  ...
  return (
    <div className="mb-6 animate-fade-in animate-stagger-2">
      ...
      >
        <CarouselContent>
          {banners.map((banner) => (
            <CarouselItem key={banner.id} className="py-1">
              <div 
                className={cn(
                  banner.bgColor,
                  "text-white p-5 rounded-xl relative overflow-hidden"
                )}
              >
                ...
                <div 
                  className="absolute top-0 right-0 w-full h-full bg-no-repeat bg-right bg-contain opacity-20"
