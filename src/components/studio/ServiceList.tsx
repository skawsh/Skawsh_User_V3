...
const ServiceList: React.FC<ServiceListProps> = ({ services }) => {
  ...
  return (
    <div className={cn("mt-0 animate-fade-in p-4 rounded-lg transition-colors duration-300 -mx-2", backgroundColors[selectedTab as keyof typeof backgroundColors])}>
