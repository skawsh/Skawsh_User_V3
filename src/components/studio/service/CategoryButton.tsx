...
const CategoryButton: React.FC<CategoryButtonProps> = ({
  ...
  return <div className="fixed right-6 z-40 flex flex-col items-center transition-all duration-300 animate-scale-in" style={{
    bottom: cartItemsCount > 0 ? '96px' : '24px'
  }}>
