    ...
    <Layout hideFooter={true}>
      <div className="min-h-screen flex flex-col items-center justify-center bg-white px-4">
        <div className="mb-12 text-center">
          ...
          />
          <h1 className="text-4xl font-bold mt-8 mb-4 text-primary-500">Welcome to Skawshway</h1>
        ...
        <div className="flex flex-col space-y-4 w-full max-w-xs">
          ...
          <Link to="/signup">
            <Button 
              variant="outline" 
              className="w-full border-primary-500 text-primary-500 hover:bg-primary-50 text-lg py-6"
            >
              Sign Up
            </Button>
          </Link>
