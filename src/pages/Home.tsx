  ...
  return <Layout>
    <div className="section-container p-0">
      ...
      <div className="px-4 pb-1 -mx-4" ref={servicesRef}>
        ...
        <div id="services-row" ref={servicesRowRef} className={`${isSticky ? 'fixed top-0 left-0 right-0 bg-gradient-to-r from-[#020024] via-[#090979] to-[#00d4ff] backdrop-blur-sm shadow-md z-40 px-4 py-2 border-b' : 'bg-white'} transition-all duration-300 ease-in-out will-change-transform`}>
