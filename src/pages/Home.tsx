  ...
  return (
    <Layout>
      <div className="section-container p-0">
        <div style={{
          background: 'linear-gradient(90deg, rgba(131,58,180,0.044497022441789214) 0%, rgba(253,29,29,1) 50%, rgba(252,205,69,1) 100%)'
        }} className="px-4 -mx-4 -mt-10 pt-4 pb-1 rounded-b-3xl">
          <LocationBar />
          <SearchBar />
